 ...
 */
// write your code here
func cartFunction(array : [String]) {
    for item in cart {
        print(item)
    }
}
 ...
 */
// write your code here
var arrayOfNames = ["Michael Thomas", "Jordan Kiley", "Human Being"]
...
intsLessThan50 = []
func filterLessThan50 (arrayOfNums : [Int]) -> [Int] {
